    ...
    <div className="pb-20">
      <header className="bg-linear-to-b from-(--qf-primary) to-(--qf-deep) text-white px-5 pt-5 pb-6 rounded-b-3xl">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h1 className="text-xl font-bold">ביקורות</h1>
        </div>
        <div className="flex items-baseline gap-3">
          <div className="text-4xl font-bold tnum">{summary.average.toFixed(1)}</div>
      ...
      <section className="px-5 -mt-4">
        <div className="bg-white rounded-2xl border border-qf-line shadow-sm p-4 space-y-1.5">
      ...
      {pendingOrderId && (
        <section className="px-5 mt-4">
          ...
          >
            ...
            <div className="text-xs text-qf-ink2 mt-0.5">לחץ כאן כדי להוסיף דירוג וטקסט קצר</div>
          </Link>
        </section>
      )}
      ...
      <section className="px-5 mt-4 space-y-3">
        {reviews.length === 0 ? (
          <div className="bg-white rounded-2xl border border-qf-line p-8 text-center text-sm text-qf-mute">
