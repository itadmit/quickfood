        ...
        <div className="flex items-start sm:items-center gap-3 min-w-0 flex-1">
          ...
          <div className="flex-1 min-w-0 leading-snug">
            <span className="font-medium">
              תקנון המוצג באתר מבוסס על נוסח לדוגמה שסופק על ידי קוויק פוד.
            </span>{" "}
            <span className="text-qf-ink2">
              באחריותך הבלעדית לבדוק, לערוך, להתאים ולאשר את התקנון בהתאם לפעילות
              העסק ולדרישות החוק וחברת הסליקה. קוויק פוד אינה נושאת באחריות לתוכן
              התקנון או לשימוש בו.
            </span>
          </div>
        </div>
