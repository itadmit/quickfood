        ...
        <div className="relative flex flex-col min-h-0">
          ...
          >
            ...
            <ul className="list-disc ps-5 space-y-2">
              ...
              <li>
                התמונות והתכנים אינם של Wolt - הם שלך. אתה זה שצילם, הזמין
                או רכש אותם, ו-Wolt רק הציגה אותם בחנות שלך אצלה. אם תוכן
                מסוים הופק עבורך על ידי Wolt או צלם מטעמה בכפוף להסכם בלעדיות -
                אל תייבא אותו.
              </li>
              <li>
