      ...
      <div className={styles.container}>
        ...
        <div className={styles.showcaseGrid}>
          ...
          <div className={styles.showcaseCard}>
            ...
            <p>אפליקציה שטעונה תוך שניה, צבעים שלך, לוגו שלך. הלקוח שומר אותך במסך הבית, חוזר ישר לכתובת שלך, ומקבל וואטסאפ ׳ההזמנה התקבלה׳ לפני שהוא הגיע לאוטו.</p>
    ...
    <section id="pricing" className={styles.section}>
      <div className={styles.container}>
        <div className={styles.pricingHead}>
          ...
          <p className={styles.sectionLede}>
            בלי טיירים, בלי הפתעות בעוד שנה, בלי שדרוגי קומה כפויים. אותו מחיר היום, אותו מחיר בעוד עשר שנים — בלי תלות בכמה הזמנות יצאו לך החודש.
          </p>
        </div>
        ...
        <div className={styles.faqGrid}>
          ...
          <div>
            ...
            <details className={styles.faqItem}>
              ...
              <p>
                זו עמלת הסליקה שאנחנו גובים על כל הזמנה — מה ששלמה לחברת האשראי שלך פלוס המעט שלנו על הפעולה. הלקוח שילם 100 ש״ח? חמישים אגורות יורדו לך, וזהו. כל השאר — שלך, כולל הלקוח עצמו, ההיסטוריה שלו, והמספר שלו.
              </p>
            </details>
            <details className={styles.faqItem}>
      ...
      <div className={styles.container}>
        <div className={styles.finalCtaCard}>
          <div className={styles.finalCtaBody}>
            ...
            <p>
              בלי כרטיס אשראי, בלי התחייבות, בלי שיחת מכירה. תיפתח חנות, תקבל הזמנה אחת, ותראה איך זה מרגיש כשהמנה הולכת ישר מהמטבח שלך ללקוח שלך — עם השם שלך על האפליקציה.
            </p>
