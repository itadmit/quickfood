    ...
    <section id="features" className={styles.section}>
      <div className={styles.container}>
        ...
        <div className={styles.miniGrid}>
          ...
          <MiniCell tag="הודעות" title="הודעות חנות + אלרגנים" body="׳חסר היום: גבינת בופלו׳, ׳כל המוצרים כשרים פרווה׳, התראת אלרגן על פריט מסוים - מנוהל מההגדרות, מופיע בחנות בלי לפתוח מוצר מזויף כמו ב-Wolt." />
          ...
          <MiniCell tag="זמינות" title="פריט לפי שעה / יום / מלאי" body="׳פיצה ארוחת בוקר רק בין 8-11׳, ׳צ׳יפס רק בערב׳, ׳20 יחידות והפריט נעלם להיום׳. אתה מגדיר פעם אחת, האפליקציה מסתירה ומחזירה לבד." />
          <MiniCell tag="מועדפים" title="לקוח חוזר = הזמנה בקליק" body="לקוח רואה את ההזמנה הקודמת שלו על דף הבית של החנות, מסמן פריטים כמועדפים, וחוזר על אותה הזמנה בכפתור אחד - כולל הכתובת והתוספות מהפעם הקודמת." />
        </div>
      </div>
    </section>
  );
