    ...
    <header className={styles.hero}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.heroBadges}>
          ...
          <span className={styles.heroBadge}>לוח הזמנות חי</span>
          ...
          <div className={styles.growSplit}>
            <div className={styles.growPrice}>
              ...
              <div className={styles.growPriceNote}>
                התעריף משולם ישירות ל-Grow, לא ל-QuickFood. שני התעריפים מצטרפים לעמלות הפלטפורמה שלנו (₪299 / 0.5%). המנוי כולל עד 100 עסקאות ומסמכים בחודש - כל עסקה או מסמך נוסף בתוספת ₪0.7.
              </div>
            </div>
            ...
            <ul className={styles.growList}>
              ...
              <li>
                ...
                <span>פעילים מהיום הראשון, בלי הפעלה ידנית ובלי &quot;חבילת תוספים&quot;. עסקה באמצעות bit ו-PayBox - תוספת של 0.3%; Apple Pay / Google Pay - תוספת של ₪0.5 לעסקה.</span>
              </li>
              <li>
                <strong>חשבוניות מס - כלולות במנוי</strong>
                <span>על כל הזמנה Grow מנפיקה חשבונית מס תקנית ושולחת ללקוח, בלי חשבון נפרד אצל סולק חשבוניות. עד 100 עסקאות ומסמכים בחודש כלולים במנוי.</span>
              </li>
              <li>
                <strong>תשלום בהעברה בנקאית</strong>
                <span>אפשר לקבל תשלום גם בהעברה בנקאית ישירות לחשבון - בעלות של ₪3.5 להעברה.</span>
              </li>
              <li>
