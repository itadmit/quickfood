  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-qf-mute leading-relaxed max-w-xl">
        ...
        ההזמנות כך שההזמנה הבאה תתחיל שוב מ-1. <b>התפריט, הלקוחות, הצוות
        ופרטי החיוב נשמרים.</b> מומלץ לבצע הזמנות ניסיון לפני חיבור אמצעי
        תשלום לחיוב - עמלות שכבר נרשמו על הזמנות שנמסרו לא מתבטלות במחיקה.
      </p>
