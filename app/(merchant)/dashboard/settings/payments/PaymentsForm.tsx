  ...
  return (
    ...
    <div className="space-y-5">
      ...
      <div className="bg-white rounded-2xl border border-qf-line-dash p-4 lg:p-5 space-y-4">
        ...
        {!v.grow.is_active && (
          <div className="rounded-xl border-2 border-qf-yolk/50 bg-qf-yolk-soft px-4 py-3.5 flex flex-col sm:flex-row sm:items-center gap-3">
            <div className="flex-1 min-w-0">
              <div className="font-semibold text-sm text-qf-ink">אין לך עדיין סליקה?</div>
              <div className="text-xs text-qf-ink2 mt-0.5">
                הירשם ל-Grow ותתחיל לקבל אשראי, PayBox, Bit, Apple Pay ו-Google Pay.{" "}
            ...
            <Link
              ...
              className="shrink-0 inline-flex items-center justify-center px-4 py-2.5 rounded-xl bg-qf-ink text-white text-sm font-medium hover:opacity-90"
            >
              הרשמה לסליקה דרך Grow
            </Link>
          </div>
        )}
      </div>
