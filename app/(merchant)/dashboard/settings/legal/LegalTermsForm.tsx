    ...
    <div className="space-y-5">
      ...
      <div className="rounded-2xl border border-qf-yolk/50 bg-qf-yolk-soft/50 p-4 flex items-start gap-3">
        ...
        <p className="text-sm text-qf-ink2 leading-relaxed">
          המערכת יצרה עבורך באופן אוטומטי נוסח תקנון המבוסס על פרטי העסק שהוזנו
          (שם העסק, ח.פ., כתובת וטלפון).{" "}
          <span className="font-semibold text-qf-ink">
            באחריותך הבלעדית והמלאה לעבור על התקנון, לבדוק את תוכנו, להתאימו
            לפעילות העסק ולוודא שהוא עומד בדרישות הדין, הרגולציה וחברת הסליקה.
          </span>{" "}
          QuickFood מספקת כלי ליצירת נוסח ראשוני בלבד ואינה מעניקה ייעוץ משפטי.
          האחריות המלאה לתוכן התקנון, התאמתו לעסק ותקינותו המשפטית חלה על בעל
          העסק בלבד.
        </p>
      </div>
