    ...
    <div className="space-y-5 pb-8">
      ...
      <Card>
        ...
        <p className="text-sm text-qf-mute mb-4">
          שליחת מבצעים, הטבות והודעות לחברי המועדון לפי מסלול. בקרוב, עם חבילות דיוור.
        </p>
        <div className="grid sm:grid-cols-2 gap-3 opacity-60 pointer-events-none select-none">
          <div className="rounded-xl border-2 border-black/15 p-4">
            <div className="flex items-center gap-2 font-black mb-1">
              <IcoMegaphone c="#000" s={16} /> Poply — אימייל ו-SMS
            </div>
            <p className="text-xs text-qf-mute">
              קמפיינים מתוזמנים, פילוח לפי מסלול ונקודות, ודוחות פתיחה/הקלקה דרך ה-API של Poply.
            </p>
          </div>
          <div className="rounded-xl border-2 border-black/15 p-4">
            <div className="flex items-center gap-2 font-black mb-1">
              <IcoWhatsApp c="#000" s={16} /> WhatsApp (iBot)
            </div>
            <p className="text-xs text-qf-mute">
              דיוור בוואטסאפ לחברי המועדון דרך החיבור הקיים של iBot, מתוך מאגר הקרדיטים.
            </p>
          </div>
        </div>
      </Card>
