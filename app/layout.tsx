...
const SITE_DESCRIPTION =
  "פלטפורמת הזמנות אונליין למסעדות - תוספות, גדלים, סוג בצק, רטבי צד, מעקב הזמנה חי, וואטסאפ מהמספר שלך. ₪299 לחודש (מחיר קבוע לכל החיים) ו-0.5% להזמנה. 7 ימים ניסיון, ללא כרטיס אשראי.";
