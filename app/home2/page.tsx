...
// Story-first landing (A/B variant at /home2). One narrative:
// apps bring customers → the problem is the RETURN → you need your own asset →
// meet QuickFood Boost → how it works → every morning → proof → price → CTA.
  ...
  return (
    <section className="relative overflow-hidden" style={{ backgroundColor: YELLOW }}>
      ...
      <div className="relative max-w-6xl mx-auto px-5 py-20 lg:py-28 text-center">
        ...
        <h1 className="text-black font-black text-4xl lg:text-6xl leading-[1.05]">
          אפליקציות המשלוחים מצוינות בלהביא לקוח חדש.
          <br />
          <span className="bg-black text-[#F8CB1E] px-3 rounded-lg inline-block mt-3">הבעיה מתחילה כשהוא חוזר.</span>
        </h1>
        <p className="mt-6 text-black/80 text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed">
...
// Beat 2 — the problem: who actually profits from your loyal customer?
function Problem() {
  return (
    <section className="max-w-6xl mx-auto px-5 py-20">
      <h2 className="font-black text-3xl lg:text-4xl text-center leading-tight">
        מי באמת מרוויח מהלקוח הקבוע שלך?
      </h2>
      ...
      <div className="mt-10 grid md:grid-cols-2 gap-5">
        <div className="rounded-3xl border-2 border-black p-7 shadow-[0_3px_0_#000]">
          ...
          <ul className="mt-4 space-y-2 text-qf-ink2 text-sm">
        ...
        <div className="rounded-3xl border-2 border-black p-7 shadow-[0_3px_0_#000]" style={{ backgroundColor: YELLOW }}>
          ...
          <ul className="mt-4 space-y-2 text-black/80 text-sm font-medium">
...
// Beat 3 — you don't need another website. You need an ASSET.
function Asset() {
  return (
    <section className="bg-black text-white">
      <div className="max-w-4xl mx-auto px-5 py-24 text-center">
        ...
        <p className="mt-6 text-white/60">
          כל לקוח שעובר להזמין ישירות הופך לחלק מהנכס הדיגיטלי של המסעדה שלך.
        </p>
      </div>
    </section>
  );
...
// Beat 4 — meet the product (revealed here, not before).
  ...
  return (
    <section className="relative overflow-hidden" style={{ backgroundColor: YELLOW }}>
      ...
      <div className="relative max-w-4xl mx-auto px-5 py-24 text-center">
        ...
        <p className="mt-5 text-black/80 text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed">
          המנוע שהופך לקוחות מזדמנים — מ-Wolt, מגוגל, מהרחוב — ללקוחות ישירים שחוזרים אליך,
          ובונה לך את הנכס הדיגיטלי שלך, צעד אחר צעד.
        </p>
      </div>
    </section>
  );
...
// Beat 5 — how it works, as a simple flow (not a wall of text).
function HowItWorks() {
  const steps = [
...
// Beat 6 — what happens every morning.
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-qf-ink2 text-lg leading-relaxed">
              לא דוחות ולא גרפים. סקירה אחת של 30 שניות עם ההזדמנויות של היום — ומה הצעד הבא
              שיחזיר לך לקוחות ויגדיל הזמנות ישירות.
            </p>
          </div>
          <div className="rounded-3xl border-2 border-black bg-white p-6 shadow-[0_3px_0_#000]">
...
function Proof() {
  return (
    <section className="max-w-5xl mx-auto px-5 py-20 text-center">
      ...
      <p className="mt-4 text-qf-ink2 text-lg max-w-2xl mx-auto leading-relaxed">
      ...
      <div className="mt-8 grid grid-cols-3 gap-4 max-w-xl mx-auto">
        {[
          ...
          <div key={s.l} className="rounded-2xl border-2 border-black p-4 shadow-[0_3px_0_#000]">
  ...
  return (
    <section className="relative overflow-hidden" style={{ backgroundColor: YELLOW }}>
      ...
      <div className="relative max-w-xl mx-auto px-5 py-20">
        ...
        <p className="mt-3 text-black/70 text-center">
          השאר פרטים ונחזור אליך — או התחל לבד עכשיו.
        </p>
