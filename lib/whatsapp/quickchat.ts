 ...
 *
 * Unlike iBot, this goes through Meta's Cloud API on QuickFood's verified
 * business number, so it cannot get the sender banned and replies land in
 * the Quick Chat inbox where the team already works.
 *
